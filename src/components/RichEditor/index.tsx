    ...
    return (
      <div>
        <div className='text-left'>
          {engineInitialed ? (
            <Toolbar className='!border-t-0' engine={this.engine!} items={[['collapse'], ['bold']]} />
          ) : null}
        </div>
        <div className='w-[782px] px-4 pt-4 mx-auto border-x border-gray-100 min-h-[calc(100vh_-_100px)]' ref={(ref) => (this.domRef = ref!)}></div>
      </div>
    );
  }
}
